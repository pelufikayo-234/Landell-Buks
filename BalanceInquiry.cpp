...
#include "LibraryDatabase.h" // BankDatabase class definition

// BalanceInquiry constructor initializes base-class data members
BalanceInquiry:: BalanceInquiry( int userID, Screen &lmsScreen, 
   BankDatabase &libDatabase )
   : Transaction( userID, lmsScreen, libDatabase )
{
   // empty body
